...
// slot of CallOverlay (which draws the INCOMING/LIVE badge on top). No hardware
// or /api/cameras request. `state` is 'ringing' | 'in-call'.
export default function SimulatedCamera({ state }) {
